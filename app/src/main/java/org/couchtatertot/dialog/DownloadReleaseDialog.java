...
public class DownloadReleaseDialog extends SherlockDialogFragment {

	private int id;

	public DownloadReleaseDialog(int id)
	{
		this.id = id;
	}
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		ReleaseDownloadTask task = new ReleaseDownloadTask(pref, id){
			@Override
			protected void onPostExecute(Void result) {
				if ( dialog != null && dialog.isShowing() )
					dialog.dismiss();
				DownloadReleaseDialog.this.onPostExecute();
			}};
		task.execute();
		return dialog;
	}

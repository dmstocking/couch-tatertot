...
public class SearchFragment extends LoadingListFragment<SearchParams, Void, SearchResultsJson> {
	...
	public void onListItemClick(ListView l, View v, int position, long id) {
		...
		InfoJson item = searchAdapter.getItem(position);
		Intent intent = new Intent( this.getSherlockActivity(), AddMovieActivity.class );
		intent.putExtra("imdb", item.imdb);
		intent.putExtra("title", item.originalTitle);
		intent.putExtra("titles", item.titles.toArray( new String[item.titles.size()] ) );
